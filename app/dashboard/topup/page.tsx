    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-[#111827]/60 border border-[#1e2d4a]/50 text-white placeholder-slate-500 text-sm focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/50 transition-all"
          />
          {query && (
            <button onClick={() => setQuery('')}
              className="absolute inset-y-0 right-3 flex items-center text-[#5a8099] hover:text-[#e4f0f6] transition-colors">
      ...
      <div className="rounded-lg border border-[#1e2d4a]/30 p-5 flex items-start gap-4" style={{ background: 'rgba(10,15,30,0.85)' }}>
        ...
        <div>
          ...
          <p className="text-[#a8c4d4] text-xs mt-1 leading-relaxed">
